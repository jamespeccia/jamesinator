...
public class PhemexClient extends Client {
    ...
    public final static String API_KEY = "bdd1a81e-cedb-417c-8232-9fe242aeef1b";
    public final static String SECRET = "Z7AZhsVsZw-zbTDTO2OU5MeqhtVY8nPdwt7eqGTCHAFiZjY0OWVhOC0wZDI3LTQwMjMtYmU3Ny0wZDUyYTIwZTNkMDI";
    public final static String BASE_ENDPOINT = "api.phemex.com";
    private final static HttpClient httpClient = HttpClients.createMinimal();
    ...
    private static JSONObject placeActiveOrder(String orderSymbol, String orderSide, String orderType, double orderPrice, int orderQuantity, double takeProfit, double stopLoss) {
        ...
        try {
            signature = sign("/orders" + expiry + body);
        } catch (NoSuchAlgorithmException | InvalidKeyException e) {
            Logger.log("An error was thrown while signing a Phemex API request. Order was never placed. (" + e.toString() + ")");
            return null;
        }
        ...
        try {
            ...
            Logger.log("An error was thrown while attempting to place an order on Phemex. Unknown if order was placed. (" + e.toString() + ")");
            return null;
        }
        ...
        try {
            ...
            Logger.log("An error was thrown while attempting to parse a Phemex response. (" + e.toString() + ")");
            return null;
        }
